    ...
    <div className="min-h-screen bg-ink">
      ...
      <main id="main-content" className="pt-16">
        ...
        <section className="relative border-b border-white/[0.04] overflow-hidden">
          <div
            className="pointer-events-none absolute inset-0 bg-grid-dots opacity-40"
          ...
          <div className="container-site relative z-10 py-24 lg:py-32">
            ...
            >
              ...
              <p className="text-lg text-white/45 max-w-xl leading-relaxed">
                Representative work across web, AI, and automation. Details
          ...
          <div className="container-site">
                    ...
                    >
                      ...
                      <div className="flex flex-col flex-1 p-6">
                        ...
                        <div className="mt-6 flex items-end justify-between">
                          <div>
                            <div className="label-mono text-white/20 mb-1">
                              Outcome
                            </div>
            ...
            >
              <p className="text-sm text-white/30 mb-5">
                Details are anonymized. Discuss specific engagement experience
