...
const About = () => {
  ...
  return (
    <main className="min-h-screen bg-[#E1EBF0]">
      <Navbar />

      {/* Page title — compact */}
      <header className="relative border-b border-border bg-[#E1EBF0] pt-[4.75rem] pb-5 md:pt-[5.25rem] md:pb-6">
        <div className="absolute inset-0 grid-pattern opacity-[0.2] pointer-events-none" />
        <div className="container-custom relative z-10 max-w-4xl">
          <nav
            aria-label="Breadcrumb"
            className="mb-3 text-xs text-slate-500 sm:text-sm"
          >
            <Link
              to="/"
          ...
          >
            <p className="text-[0.625rem] font-bold uppercase tracking-[0.18em] text-primary sm:text-xs">
      ...
      <div className="container-custom py-6 md:py-8">
        <div className="mx-auto max-w-4xl overflow-hidden rounded-2xl border border-slate-200/90 bg-white shadow-[0_4px_24px_-12px_rgba(15,23,42,0.1)]">
          ...
          <motion.section
            {...fadeUp}
            className={`${sectionPad} border-b border-slate-100`}
          ...
          >
            <motion.div {...fadeUp}>
              ...
              <p className="mt-2 text-sm leading-snug text-slate-600">
                Six practice areas—scoped standalone or as part of a broader
                program.
              </p>
            </motion.div>
          ...
          >
            ...
            <p className="mt-2 text-sm leading-snug text-slate-600">
              {ABOUT_PAGE.principlesIntro}
            </p>
            <ul
              className="mt-4 space-y-2.5 border-t border-slate-200/80 pt-4"
              role="list"
            >
          ...
          <section className={sectionPad} aria-labelledby="location-heading">
            <div className="flex flex-col gap-3 sm:flex-row sm:items-start sm:gap-4">
              ...
              <div className="min-w-0 flex-1">
                <h2
                  id="location-heading"
                  className="text-[0.625rem] font-semibold uppercase tracking-[0.12em] text-slate-500"
                >
                  Headquarters
                </h2>
                ...
                <p className="mt-1 text-xs text-slate-600">
                  Remote delivery for clients across India and overseas.
                </p>
              </div>
            </div>
            ...
            <div className="mt-5 flex flex-col gap-3 rounded-xl bg-primary px-4 py-4 text-primary-foreground sm:flex-row sm:items-center sm:justify-between sm:px-5">
              <p className="text-xs font-medium leading-snug text-black sm:max-w-[70%] sm:text-sm">
                Discuss scope or a statement of work—we respond to new business
                inquiries within one business day.
              </p>
              <Button
                variant="secondary"
                size="default"
                className="shrink-0 border-0 bg-white text-primary hover:bg-slate-100 text-sm"
                asChild
              >
